...
// .wrangler/tmp/bundle-aXZQ7w/checked-fetch.js
...
// .wrangler/tmp/bundle-aXZQ7w/strip-cf-connecting-ip-header.js
...
// node_modules/.pnpm/hono@4.7.11/node_modules/hono/dist/middleware/pretty-json/index.js
...
// node_modules/.pnpm/@hono+zod-validator@0.2.2_hono@4.7.11_zod@3.25.56/node_modules/@hono/zod-validator/dist/esm/index.js
...
var BookmarkSchema = external_exports.object({
  ...
  title: external_exports.string().min(1, "\u6807\u9898\u4E0D\u80FD\u4E3A\u7A7A"),
  url: external_exports.string().url("URL \u683C\u5F0F\u4E0D\u6B63\u786E").optional(),
  dateAdded: external_exports.number().optional(),
  dateGroupModified: external_exports.number().optional(),
  unmodifiable: external_exports.enum(["managed"]).optional(),
  children: external_exports.array(external_exports.lazy(() => BookmarkSchema)).optional(),
  // 自定义扩展字段
...
var CreateBookmarkSchema = external_exports.object({
  title: external_exports.string().min(1, "\u6807\u9898\u4E0D\u80FD\u4E3A\u7A7A").max(200, "\u6807\u9898\u8FC7\u957F"),
  url: external_exports.string().url("URL \u683C\u5F0F\u4E0D\u6B63\u786E"),
  tags: external_exports.array(external_exports.string()).optional().default([]),
  description: external_exports.string().max(1e3, "\u63CF\u8FF0\u8FC7\u957F").optional().default("")
});
var UpdateBookmarkSchema = external_exports.object({
  title: external_exports.string().min(1, "\u6807\u9898\u4E0D\u80FD\u4E3A\u7A7A").max(200, "\u6807\u9898\u8FC7\u957F").optional(),
  url: external_exports.string().url("URL \u683C\u5F0F\u4E0D\u6B63\u786E").optional(),
  tags: external_exports.array(external_exports.string()).optional(),
  description: external_exports.string().max(1e3, "\u63CF\u8FF0\u8FC7\u957F").optional()
});
var BookmarkQuerySchema = external_exports.object({
  page: external_exports.coerce.number().min(1).optional().default(1),
  pageSize: external_exports.coerce.number().min(1).max(100).optional().default(20),
  search: external_exports.string().optional(),
  tags: external_exports.string().optional().transform((val) => val ? val.split(",").filter(Boolean) : [])
});
var SearchBookmarkSchema = external_exports.object({
  q: external_exports.string().min(1, "\u641C\u7D22\u5173\u952E\u8BCD\u4E0D\u80FD\u4E3A\u7A7A"),
  tags: external_exports.string().optional().transform((val) => val ? val.split(",").filter(Boolean) : []),
  limit: external_exports.coerce.number().min(1).max(50).optional().default(10)
});
...
var BookmarkService = class {
  ...
  async getBookmarks(query) {
    ...
    for (const key of bookmarkKeys) {
      const bookmarkData = await this.kv.get(key, "json");
      if (bookmarkData) {
    ...
    if (search) {
      ...
      filteredBookmarks = filteredBookmarks.filter(
        (bookmark) => bookmark.title.toLowerCase().includes(searchLower) || bookmark.url.toLowerCase().includes(searchLower) || bookmark.description?.toLowerCase().includes(searchLower)
      );
    }
    if (tags.length > 0) {
      filteredBookmarks = filteredBookmarks.filter(
        (bookmark) => tags.some((tag) => bookmark.tags?.includes(tag))
      );
    }
  ...
  async getBookmark(id) {
    const bookmark = await this.kv.get(id, "json");
    return bookmark;
  }
  /**
   * 创建书签
   ...
   * 搜索书签
   */
  async searchBookmarks(keyword, options = {}) {
  ...
  async getTags() {
    ...
    for (const key of bookmarkKeys) {
      const bookmark = await this.kv.get(key, "json");
      if (bookmark?.tags) {
...
// .wrangler/tmp/bundle-aXZQ7w/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-aXZQ7w/middleware-loader.entry.ts
